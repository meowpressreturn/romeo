...
public class TestUnitImporterImpl {
  ...
  public void testConstructor() {
    new UnitImporterImpl(LoggerFactory.getLogger(UnitImporterImpl.class),_mockUnitService);

    try {
      new UnitImporterImpl(LoggerFactory.getLogger(UnitImporterImpl.class),null);
  ...
  public void testImportNoAdjustments() {      
    ...
    UnitImporterImpl unitImporter = new UnitImporterImpl(LoggerFactory.getLogger(UnitImporterImpl.class), _mockUnitService);
  ...
  public void testUpdates() {
    ...
    //be updated. 
    _listener.reset();
    UnitImporterImpl unitImporter = new UnitImporterImpl(LoggerFactory.getLogger(UnitImporterImpl.class), _mockUnitService); //Mock file of csv unit data (as strings)
